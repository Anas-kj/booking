  ...
  return (
    <Form {...form}>
        <form 
            ...
            className="flex flex-col lg:flex-row max-w-6xl lg:mx-auto items-center justify-center
        ...
        >
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel className="flex text-white">
                                Location
                                <BedDoubleIcon className="ml-2 w-4 h-4 text-white" aria-hidden="true"/>
                            </FormLabel>
            ...
            <div className="grid w-full lg:max-w-sm items-center gap-1.5">
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel className="flex flex-col w-full text-white">Dates</FormLabel>
                            <FormMessage/>
                            <Popover>
                                <PopoverTrigger asChild>
                                    <FormControl>
                                        <Button
                                            ...
                                            variant={"outline"}
                                            className={cn(
                                                "w-full lg:w-[300px] text-left justify-start font-normal",
                                                !field.value.from &&"text-muted-foreground"
                                            )}
                                        >
                                            <CalendarIcon className="w-4 h-4 mr-3 opacity-50" aria-hidden="true"/>
                                            {field.value?.from ? (
                                                field.value?.to ? (
                                                    <>
